...
function showtask(){
    ...
    taskObj.forEach((item, index) => {
        ...
        html += `<tr>
                   ...
                   <span class="haha"> ${taskCompleteValue} </span>
                   <td><button type="button" onclick="edittask(${index})" class="text-white"><i class="fa fa-edit"></i></button></td>
                   <td><button type="button" class="text-success font-weight-bold" id=${index}><i class="fa fa-check-square-o"></i> Complete </button></td>
                   <td><button type="button" onclick="deleteitem(${index})" class="text-white"><i class="fa fa-trash"></i></button></td>
                </tr>`;
    });
